    ...
    return (
        <div className='md:flex justify-between space-x-4 relative '>
            <div className=' w-full md:w-1/2'>
                <Nav/>
                <p className='leading-loose md:mt-12 mt-6'>Experience double the luxury at <span className='bg-[#006B8D] text-white p-2 m-2'>Saadiyat Lagoon</span> and <br/> <span className='bg-[#006B8D] text-white p-2 '>Yas Golf Collection!</span>
